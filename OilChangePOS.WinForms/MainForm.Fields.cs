...
public partial class MainForm : Form
{
    ...
    private readonly Label _reportPeriodBanner = new() { Dock = DockStyle.Top, Height = 42, ForeColor = Color.White, BackColor = Color.FromArgb(44, 62, 80), TextAlign = ContentAlignment.MiddleRight, Padding = new Padding(0, 0, 16, 0), RightToLeft = RightToLeft.No };
    ...
    private readonly Label _kpiBranchSalesVal = new() { AutoSize = false, TextAlign = ContentAlignment.MiddleRight, RightToLeft = RightToLeft.No };
    private readonly Label _kpiBranchInvVal   = new() { AutoSize = false, TextAlign = ContentAlignment.MiddleRight, RightToLeft = RightToLeft.No };
    private readonly Label _kpiBranchLowVal   = new() { AutoSize = false, TextAlign = ContentAlignment.MiddleRight, RightToLeft = RightToLeft.No };
    private readonly Label _kpiBranchNameVal  = new() { AutoSize = false, TextAlign = ContentAlignment.MiddleRight, RightToLeft = RightToLeft.No };
