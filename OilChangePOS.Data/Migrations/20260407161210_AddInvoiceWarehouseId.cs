...
{
    /// <summary>
    /// Full model initial migration (EF Core had no prior history). Safe for empty databases via <c>dotnet ef database update</c>.
    /// Existing databases maintained with <c>EnsureCreated</c> + <see cref="DatabaseInitializer"/> receive the nullable
    /// <c>Invoices.WarehouseId</c> column from idempotent SQL in <c>EnsureWarehouseSchemaAsync</c>; avoid applying this migration
    /// to those DBs unless you reconcile <c>__EFMigrationsHistory</c> with a baseline strategy.
    /// </summary>
    /// <inheritdoc />
    public partial class AddInvoiceWarehouseId : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PackageSize = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StockAudits_Users_CreatedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ServiceNumber = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StockAuditLines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StockAuditLines_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StockAuditLines_StockAudits_StockAuditId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceDetails_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceDetails_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceOrders_ServiceNumber",
                table: "ServiceOrders",
                column: "ServiceNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_StockAuditLines_ProductId",
                table: "StockAuditLines",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_StockAuditLines_StockAuditId",
                table: "StockAuditLines",
                column: "StockAuditId");

            migrationBuilder.CreateIndex(
                name: "IX_StockAudits_CreatedByUserId",
                table: "StockAudits",
                column: "CreatedByUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockMovements_ProductId_MovementDateUtc",
                table: "StockMovements",
                columns: new[] { "ProductId", "MovementDateUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_StockMovements_ToWarehouseId_FromWarehouseId_MovementDateUtc",
                table: "StockMovements",
                columns: new[] { "ToWarehouseId", "FromWarehouseId", "MovementDateUtc" });
