...
public static class DatabaseInitializer
{
    ...
    public static async Task SeedAsync(OilChangePosDbContext dbContext)
    {
        ...
        await EnsureInvoiceContainsEstimatedCostSchemaAsync(dbContext);
    ...
    private static async Task EnsureInvoiceContainsEstimatedCostSchemaAsync(OilChangePosDbContext dbContext)
    {
        await dbContext.Database.ExecuteSqlRawAsync(
            """
            IF OBJECT_ID(N'[dbo].[Invoices]', N'U') IS NOT NULL
