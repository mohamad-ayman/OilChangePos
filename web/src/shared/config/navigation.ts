...
export const navigationSections: NavSection[] = [
  {
    ...
    items: [
      { id: 'pos', labelKey: 'nav.pos', path: '/app/pos', icon: 'pos', allowedRoles: ['admin', 'manager', 'cashier'] },
    ],
  },
  {
    id: 'stock',
    ...
    items: [
      ...
      { id: 'products', labelKey: 'nav.products', path: '/app/products', icon: 'products', allowedRoles: ['admin'] },
      { id: 'transfers', labelKey: 'nav.transfers', path: '/app/transfers', icon: 'transfers', allowedRoles: ['admin'] },
      { id: 'purchases', labelKey: 'nav.purchases', path: '/app/purchases', icon: 'purchases', allowedRoles: ['admin'] },
    ],
  },
  {
    id: 'insights',
  ...
  },
  {
    ...
    items: [{ id: 'users', labelKey: 'nav.users', path: '/app/users', icon: 'users', allowedRoles: ['admin'] }],
  },
]
